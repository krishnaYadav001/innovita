                ...
                <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                    ...
                    <div className="mt-8 md:flex gap-6">
                        {!fileDisplay ? (
                            ...
                            <div
                            className="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative"
                            >
                                {isUploading ? (
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-[#F8F8F8] py-4 px-6">
                                ...
                                <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                                    <button className="px-8 py-1.5 text-white text-[15px]  bg-[#F03C56] rounded-sm">
                                        Edit
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="px-10 py-2.5 mt-8 border text-white bg-[#F02C56] rounded-sm"
                                >
